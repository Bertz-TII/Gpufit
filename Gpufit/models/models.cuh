    ...
    int const user_info_size)
{
    ...
    case CAUCHY_LORENTZ_1D_NUM:
        calculate_cauchy_lorentz_1d_num(parameters, n_fits, n_points, value, derivative, point_index, fit_index, chunk_index, user_info, user_info_size);
        break;
    
    case DHO_1D:
        calculate_DHO_1d(parameters, n_fits, n_points, value, derivative, point_index, fit_index, chunk_index, user_info, user_info_size);
        break; 
